...
export default function MiniDrawer() {
  ...
  const handleSectionHeaderClick = (sectionHeaderText: string) => {
    ...
    const sectionIndex = sectionHeaders.findIndex(header => header.text === sectionHeaderText);

    if (sectionIndex !== -1) {
      const updatedSectionHeaders = [...sectionHeaders];
      updatedSectionHeaders[sectionIndex].open = !updatedSectionHeaders[sectionIndex].open;
      setSectionHeaders(updatedSectionHeaders);
    }
  };

  const [sectionHeaders, setSectionHeaders] = React.useState<SectionHeaderProps[]>([
    { text: 'Dashboard', icon: <DashboardIcon />, nestedItems: [], open: false, handleClick: () => {} },
    { text: 'Drivers', icon: <PersonIcon />, nestedItems: [], open: false, handleClick: () => {} },
    { text: 'Vehicles', icon: <DriveEtaIcon />, nestedItems: [], open: false , handleClick: () => {}},
    { text: 'Passengers', icon: <PeopleIcon />, nestedItems: [], open: false, handleClick: () => {} },
    {
      text: 'Reports',
      icon: <ArticleIcon />,
      nestedItems: [
    ...
    { text: 'Trips', icon: <TimeToLeaveIcon />, open: false, handleClick: () => {} },
    { text: 'Settings', icon: <SettingsIcon />, open: false, handleClick: () => {} },
  ]);
